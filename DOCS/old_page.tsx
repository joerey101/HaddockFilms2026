...
export default async function FilmPage({ params }: Props) {
  ...
  return (
    <div className="bg-bg-dark text-fg-on-dark min-h-screen relative overflow-x-hidden selection:bg-accent selection:text-white">
      ...
      {/* We pass a custom theme for Navbar if needed, or it adapts */}
      <Navbar />
      ...
      <main>
        ...
        {film.awards && film.awards.length > 0 && (
          <section className="py-24 px-[6vw] bg-bg-dark border-t border-white/10">
            <h3 className="text-[10px] font-sans tracking-[0.2em] text-accent uppercase mb-8">Reconocimientos</h3>
            <div className="flex flex-col gap-4">
              {film.awards.map((award, idx) => (
                <div key={idx} className="border-b border-white/5 py-4 last:border-b-0">
                  <p className="font-sans text-sm text-fg-on-dark-muted leading-relaxed">
